...
export default function LoginPage() {
  ...
  const getRedirectPath = (role: Role): string => {
    switch (role) {
      case "SUPER_DIRECTOR":
        return "/superdirector/dashboard";
      case "DIRECTOR":
        ...
        <div className="relative z-10 w-full max-w-lg space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <Button
                type="submit"
                className="w-full border-0 from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/30 hover:from-blue-700 hover:to-purple-700 dark:shadow-blue-500/20"
              >
                Sign in
              </Button>
            </div>
